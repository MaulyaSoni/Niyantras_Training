...
# #---------------------------Create----------------------------------
# def create_emp_data(db : Session , emp : EmployeeSchema , user_log : Users):
...
# def create_dept_data(db : Session , dept : DepartmentSchema , user_log : Users):
...
# def create_user(db: Session,user_data: UsersSchema , user_log : Users):
...
# def update_emp(db : Session , emp_id : str , emp : EmployeeSchema , background_tasks : BackgroundTasks , log_user : Users):
#     employee =  db.get(Employee , emp_id)
...
#     logging.info(f"{emp_id}, employee updated by user : {log_user.username}")
    
#     return employee

#-----------------------Delete-----------------------------------------------------------

# def delete_emp(db : Session , emp_id : str , user_log : Users):
...
# def delete_dept(db:Session , dept_id : str ,user_log : Users):
